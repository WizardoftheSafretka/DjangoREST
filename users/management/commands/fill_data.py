...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        Payment.objects.create(
            user=user1, paid_course=course1, amount=4999.00, payment_method="transfer"
        )
        Payment.objects.create(
            user=user1, paid_lesson=lesson1, amount=999.00, payment_method="cash"
        )
        Payment.objects.create(
            user=user2, paid_course=course2, amount=2999.00, payment_method="transfer"
        )
